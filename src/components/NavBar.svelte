<div class="top-container">
  <div class="navbar-header">
    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target=".navbar-collapse" aria-label="Expand">
      <span class="icon-bar" />
      <span class="icon-bar" />
      <span class="icon-bar" />
    </button>
    <h1>
      <a id="navLogo" class="navbar-brand" href="./" aria-label="Home">
    ...
    <div class="navbar-header no-overflow">
      <h1 id="pageHeader" />
    </div>
  </div>
  <div id="listNavbar" class="navbar-collapse navbar-right collapse">
    <ul class="nav navbar-nav">
      <li><a id="listList" href="list.html"> <span class="iconFont">j</span> <span id="listLink" class="linkText" /> </a></li>
      <li><a id="compareList" href="compare.html"> <span class="iconFont">K</span> <span id="compareLink" class="linkText" /> </a></li>
      <li class="dropdownLink">
        <a href="#"> <span class="iconFont">i</span> <span id="moreLink" class="linkText">MORE</span></a>
        <ul class="dropdown">
          <li><a href="solubility-chart.html">SOLUBILITY CHART</a></li>
          <li><a href="reactivity-series.html">REACTIVITY SERIES</a></li>
        </ul>
      </li>
      <li>
        <a id="printableList" href="printables.html">
          <span class="iconFont">E</span>
          <span id="printableLink" class="linkText" />
          <span id="newHeader" class="newHeader new" />
        </a>
      </li>
      <li><a id="storeList" href="store.html"> <span class="iconFont">I</span> <span id="storeLink" class="linkText" /> </a></li>
      <li>
        <a id="translateList" href="translation.html">
          <span class="iconFont">B</span>
          <span id="translateLink" class="linkText" />
          <span class="newHeader new" />
        </a>
      </li>
      <li>
        <a id="settingsList" href="#" data-toggle="modal" data-target="#settingsModal">
          <span class="iconFont">f</span>
          <span id="settingsLink" class="linkText" />
        </a>
      </li>
      <li><a id="themeList" href="#"> <span id="themeIcon" class="iconFont">t</span> <span id="themeLink" class="linkText">Theme</span> </a></li>
    </ul>
  </div>
</div>
