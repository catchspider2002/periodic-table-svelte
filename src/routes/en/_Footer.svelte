...
<div class="footer">
  <div class="flex flex-wrap justify-center pt-2">
    <a target="_blank" href="https://feedback.periodic-table.io/" rel="noopener noreferrer" class="m-1 p-2">
      <span id="suggestionLink" class="linkText">{Lang.suggestions}</span>
    </a>
    <a id="translationFooter" href="{langValue}/translation" class="m-1 p-2 flex">
      <span id="translate2Link" class="linkText">{Lang.translate}</span>
      <span class="newFooter new">{Lang.newContent}</span>
    </a>
    <a id="aboutFooter" href="{langValue}/about" class="m-1 p-2"> <span id="aboutLink" class="linkText">{Lang.about}</span> </a>
    <a id="creditsFooter" href="{langValue}/credits" class="m-1 p-2"> <span id="creditsLink" class="linkText">{Lang.credits}</span> </a>
    <a id="privacyFooter" href="{langValue}/privacy-policy" class="m-1 p-2"> <span id="privacyLink" class="linkText">{Lang.privacy}</span> </a>
  </div>
