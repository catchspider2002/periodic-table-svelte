<script>
  ...
  let modal, modalOverlay, closeButton, openButton;
  ...
  function close() {
    ...
    let modal = id("modal");
    let modalOverlay = id("modal-overlay");
...
<div class="modal" id="modal">
  <button class="close-button" id="close-button" on:click={close}>Obvious Close Button</button>
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-inner">
        <div class="modal-header">
          <span id="modalSettings" class="modal-title text-left text-upper heavyFont" />
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
        </div>
        <div class="modal-body">
          <div class="grid grid-row-gap-10 items-center">
            <div class="new-table heavyFont text-left" id="language" />
            <div class="new-table">
            ...
            <div class="new-table heavyFont text-left self-start" id="temperature" />
            ...
            <div class="new-table heavyFont padding-top-5 text-left self-start" id="themeColor" />
            <div class="new-table">
              <table id="colorTable">
                <tbody>
                  <tr>
            ...
            <div id="settingPeriodicTable" class="new-table span-2" />
            <div class="new-table heavyFont text-left" id="tableWidth" />
            <div class="new-table">
            ...
            <div class="new-table heavyFont text-left" id="settingsName" />
            ...
            <div class="new-table heavyFont text-left" id="settingsAtmWtMain" />
            <div class="new-table text-left padding-top-5">
              <label class="switch"> <input id="atmNoSelectSetting" type="checkbox" /> <span class="slider round" /> </label>
            </div>
            ...
            <div class="radio-toolbar radio-style padding-top-5">
              ...
              <label id="style1Label" class="disable-select" for="style1" />
              <input type="radio" id="style2" name="tableStyle" value="2" onchange="setStyle()" />
              <label id="style2Label" class="disable-select" for="style2" />
              <input type="radio" id="style3" name="tableStyle" value="3" onchange="setStyle()" />
              <label id="style3Label" class="disable-select" for="style3" />
            </div>
          </div>
        </div>
      </div>
