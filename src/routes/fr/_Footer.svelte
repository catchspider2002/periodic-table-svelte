...
<div class="flex flex-wrap justify-center pt-2">
  ...
  <a id="aboutFooter" href="about.html" class="m-1 p-2"> <span id="aboutLink" class="linkText">{Lang.about}</span> </a>
  <a id="creditsFooter" href="credits.html" class="m-1 p-2"> <span id="creditsLink" class="linkText">{Lang.credits}</span> </a>
  <a id="privacyFooter" href="privacy-policy.html" class="m-1 p-2"> <span id="privacyLink" class="linkText">{Lang.privacy}</span> </a>
</div>
